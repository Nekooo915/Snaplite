...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // For a menubar app, "double-clicked the .app icon" is the user's
        // most likely entry point and they reasonably expect a window to
        // appear. Without this the first launch only installs the tray
        // icon and looks like "nothing happened" from the user's POV;
        // they double-click again, applicationShouldHandleReopen fires,
        // and only THEN does the panel show. Surface it on the first
        // launch too so the two paths feel identical.
        showSettings()
    }
